...
Lorsqu'on passe de Windows à Linux, l'interface peut sembler déroutante. Voici 7 extensions GNOME qui transforment Ubuntu pour le rendre plus familier aux utilisateurs Windows.
...
Ubuntu avec GNOME a évolué vers un environnement qui peut servir de remplacement à Windows, particulièrement pour les développeurs, grâce aux extensions créées par la communauté.
